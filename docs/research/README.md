...
|---|---|---|
| [`detector-evaluation/`](detector-evaluation/) | [RFC-0005](../../spec/RFC-0005-detector-measurement.md) — measuring detectors whose rules an LLM wrote | Brief and handoff written; findings open |
